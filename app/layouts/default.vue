...
const menuItems = [
  ...
  },
  {
    ...
    icon: '<svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.877-5.877M11.42 15.17l2.492-3.396c.339-.464.321-1.09-.043-1.535L11.5 7.828m-2.921 5.467l-3.395 2.492c-.464.339-1.09.322-1.535-.043L1.172 13.27m5.467-2.921l2.492-3.396c.339-.464.321-1.09-.043-1.535L6.5 2.828m2.921 5.467l-3.395 2.492c-.464.339-1.09.322-1.535-.043L2.828 6.5" /></svg>'
  },
  {
    name: 'Notas Fiscais',
    path: '/notas-fiscais',
